...
| :--- | :--- | :--- |
| **Data** | ![Data Synthesis](https://img.shields.io/badge/Data_Synthesis-1D4ED8) | LLM-generated synthetic data (dialogues, profiles, annotations). |
| | ![Data Collection](https://img.shields.io/badge/Data_Collection-2563EB) | Expert-written or real collected data. |
| | ![Data Analysis](https://img.shields.io/badge/Data_Analysis-60A5FA) | Data analysis and preprocessing. |
| **Methodology** | ![Scripts Generation](https://img.shields.io/badge/Scripts_Generation-15803D) | Single LLM generates dialogues via carefully-designed prompts (text creation approach). |
| | ![Interactive Generation](https://img.shields.io/badge/Interactive_Generation-16A34A) | Two LLMs generate dialogues via roleplay interaction (one plays counselor, the other plays client). |
| | ![Chain-of-Thought](https://img.shields.io/badge/Chain_of_thought-4ADE80) | Adds CoT reasoning steps **before generating counselor response** (planning, analysis, reflection). |
| | ![Preference-Learning](https://img.shields.io/badge/Preference_Learning-22C55E) | DPO/RLHF/preference learning. |
| **Application** | ![Specific Therapy](https://img.shields.io/badge/Specific_Therapy-7E22CE) | Focused on specific therapies (e.g., CBT, MI, EFT, Narrative). |
| | ![Dialogue System](https://img.shields.io/badge/Dialogue_system-9333EA) | System for generating counselor responses using multi-agent or specific pipeline. |
...
| | ![Simulated Client](https://img.shields.io/badge/Simulated_Client-B489C7) | **Research focus**: studies how to build better client simulators OR **uses simulated clients for evaluation** in experiments. |
