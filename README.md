...
| | ![Data Analysis](https://img.shields.io/badge/Data_Analysis-steelblue) | Data analysis and preprocessing. |
...
- [x] **CBT-Bench**: Evaluating Large Language Models on Assisting Cognitive Behavior Therapy `Becnchmark` `Specific Therapy` `NAACL 2025`
...
- [x] Automatic Identification of Ruptures in Transcribed Psychotherapy Sessions `Dataset Analysis`
- [x] Understanding the Therapeutic Relationship between Counselors and  Clients in Online Text-based Counseling using LLMs `Dataset Analysis` `EMNLP 2024 Findings`
- [ ] From Conversation to Automation: Leveraging LLMs for Problem-Solving Therapy Analysis `Dataset Analysis` `ACL 2025 Findings` `Special Therapy`
