...
- **P1 - 多轮对话系统**: 交互式咨询与纵向多轮对话系统。
- **P2 - 训练与评测**: 对齐、临床忠实度、安全与评估。
- **P3 - 基础研究**: 数据集、模拟、分析与综述。

### 标签

- **数据**
  - ![Data Synthesis](https://img.shields.io/badge/Data_Synthesis-1D4ED8): 由 LLM 生成的合成数据，包括对话、画像和标注。
  ...
  - ![数据集](https://img.shields.io/badge/%E6%95%B0%E6%8D%AE%E9%9B%86-0F766E): 提出或实质扩展数据集。
- **方法**
  - ![Scripts Generation](https://img.shields.io/badge/Scripts_Generation-15803D): 单个 LLM 通过设计的提示生成对话。
  - ![Interactive Generation](https://img.shields.io/badge/Interactive_Generation-16A34A): 多个角色通过交互生成对话。
  - ![Chain-of-Thought](https://img.shields.io/badge/Chain--of--Thought-4ADE80): 使用显式规划、分析或反思步骤。
  - ![Preference-Learning](https://img.shields.io/badge/Preference--Learning-22C55E): 使用 DPO、RLHF 等偏好优化方法。
  - ![多智能体](https://img.shields.io/badge/%E5%A4%9A%E6%99%BA%E8%83%BD%E4%BD%93-475569): 协调多个模型智能体或角色。
- **应用**
  - ![Specific Therapy](https://img.shields.io/badge/Specific_Therapy-7E22CE): 聚焦 CBT、MI 等特定疗法。
  - ![Dialogue System](https://img.shields.io/badge/Dialogue_System-9333EA): 通过系统或流程生成咨询师回复。
  - ![Clinical Diagnostic](https://img.shields.io/badge/Clinical_Diagnostic-A855F7): 聚焦诊断或临床评估。
...
- **模态**
  - ![Multi Modal](https://img.shields.io/badge/Multi_Modal-F97316): 结合文本与图像、音频或视频。
...
- **[Multi-dimensional Assessment and Explainable Feedback for Counselor Responses to Client Resistance in Text-based Counseling with LLMs](https://arxiv.org/abs/2602.21638)**
  ...
  > **来源:** arXiv · 2026-02-25 · `arxiv:2602.21638`
...
- **[CARE: An Explainable Computational Framework for Assessing Client-Perceived Therapeutic Alliance Using Large Language Models](https://arxiv.org/abs/2602.20648)**
  ...
  > **来源:** arXiv · 2026-02-24 · `arxiv:2602.20648`
...
- **[PatientHub: A Unified Framework for Patient Simulation](https://arxiv.org/abs/2602.11684)**
  ...
  > **来源:** arXiv · 2026-02-12 · `arxiv:2602.11684`
...
- **[PsychePass: Calibrating LLM Therapeutic Competence via Trajectory-Anchored Tournaments](https://arxiv.org/abs/2601.20330)**
  ...
  > **来源:** arXiv · 2026-01-28 · `arxiv:2601.20330`
...
- **[RECAP: Resistance Capture in Text-based Mental Health Counseling with Large Language Models](https://arxiv.org/abs/2601.14780)**
  ...
  > **来源:** arXiv · 2026-01-21 · `arxiv:2601.14780`
...
- **[PsycheChat: An Empathic Framework Focused on Emotion Shift Tracking and Safety Risk Analysis in Psychological Counseling](https://arxiv.org/abs/2601.12392)**
  ...
  > **来源:** arXiv · 2026-01-18 · `arxiv:2601.12392`
...
- **[PsyCLIENT: Client Simulation via Conversational Trajectory Modeling for Trainee Practice and Model Evaluation in Mental Health Counseling](https://arxiv.org/abs/2601.07312)**
  ...
  > **来源:** arXiv · 2026-01-12 · `arxiv:2601.07312`
...
- **[MentraSuite: Post-Training Large Language Models for Mental Health Reasoning and Assessment](https://arxiv.org/abs/2512.09636)**
  ...
  > **来源:** arXiv · 2025-12-10 · `arxiv:2512.09636`
...
- **[MindEval: Benchmarking Language Models on Multi-turn Mental Health Support](https://arxiv.org/abs/2511.18491)**
  ...
  > **来源:** arXiv · 2025-11-23 · `arxiv:2511.18491`
...
- **[CARE-Bench: A Benchmark of Diverse Client Simulations Guided by Expert Principles for Evaluating LLMs in Psychological Counseling](https://arxiv.org/abs/2511.09407)**
  ...
  > **来源:** arXiv · 2025-11-12 · `arxiv:2511.09407`
...
- **[$\\Psi$-ARENA: Interactive Assessment and Optimization of LLM-based Psychological Counselors with Tripartite Feedback](https://arxiv.org/abs/2505.03293)**
  ...
  > **来源:** arxiv · 2025-05-06 · `arxiv:2505.03293`
...
- **[DeepPsy-Agent: A Stage-Aware and Deep-Thinking Emotional Support Agent System](https://arxiv.org/abs/2503.15876)**
  ...
  > **来源:** arxiv · 2025-03-20 · `arxiv:2503.15876`
...
- **[Psy-Insight: Explainable Multi-turn Bilingual Dataset for Mental Health Counseling](https://arxiv.org/abs/2503.03607)**
  ...
  > **来源:** arXiv · 2025-03-05 · `arxiv:2503.03607`
...
- **[CBT-Bench: Evaluating Large Language Models on Assisting Cognitive Behavior Therapy](https://aclanthology.org/2025.naacl-long.196/)**
  ...
  > **来源:** arxiv · 2025-03-01 · `acl:2025.naacl-long.196`
...
- **[Preference Learning Unlocks LLMs' Psycho-Counseling Skills](https://arxiv.org/abs/2502.19731)**
  ...
  > **来源:** arXiv · 2025-02-27 · `arxiv:2502.19731`
...
- **[Towards AI-Assisted Psychotherapy: Emotion-Guided Generative Interventions](https://aclanthology.org/2025.emnlp-main.1664/)**
  ...
  > **来源:** EMNLP 2025 Main · 2025 · `acl:2025.emnlp-main.1664`
...
- **[Reframe Your Life Story: Interactive Narrative Therapist and Innovative Moment Assessment with Large Language Models](https://aclanthology.org/2025.emnlp-main.1245/)**
  ...
  > **来源:** EMNLP 2025 Main · 2025 · `acl:2025.emnlp-main.1245`
...
- **[PsyDT: Using LLMs to Construct the Digital Twin of Psychological Counselor with Personalized Counseling Style for Psychological Counseling](https://aclanthology.org/2025.acl-long.55/)**
  ...
  > **来源:** ACL 2025 Main · 2025 · `acl:2025.acl-long.55`
...
- **[PsyDial: A Large-scale Long-term Conversational Dataset for Mental Health Support](https://aclanthology.org/2025.acl-long.1049/)**
  ...
  > **来源:** ACL 2025 Main · 2025 · `acl:2025.acl-long.1049`
...
- **[PanicToCalm: A Proactive Counseling Agent for Panic Attacks](https://aclanthology.org/2025.emnlp-main.649/)**
  ...
  > **来源:** EMNLP 2025 Main · 2025 · `acl:2025.emnlp-main.649`
...
- **[Multimodal Cognitive Reframing Therapy via Multi-hop Psychotherapeutic Reasoning](https://aclanthology.org/2025.naacl-long.250/)**
  ...
  > **来源:** NAACL 2025 Main · 2025 · `acl:2025.naacl-long.250`
...
- **[Mirror: Multimodal Cognitive Reframing Therapy for Rolling with Resistance](https://aclanthology.org/2025.emnlp-main.751/)**
  ...
  > **来源:** EMNLP 2025 Main · 2025 · `acl:2025.emnlp-main.751`
...
- **[IntentionESC: An Intention-Centered Framework for Enhancing Emotional Support in Dialogue Systems](https://arxiv.org/abs/2506.05947)**
  ...
  > **来源:** ACL 2025 Findings · 2025 · `arxiv:2506.05947`
...
- **[From Conversation to Automation: Leveraging LLMs for Problem-Solving Therapy Analysis](https://aclanthology.org/2025.findings-acl.1292/)**
  ...
  > **来源:** ACL 2025 Findings · 2025 · `acl:2025.findings-acl.1292`
...
- **[CRISP: Cognitive Restructuring of Negative Thoughts through Multi-turn Supportive Dialogues](https://aclanthology.org/2025.emnlp-main.1652/)**
  ...
  > **来源:** EMNLP 2025 Main · 2025 · `acl:2025.emnlp-main.1652`
...
- **[Consistent Client Simulation for Motivational Interviewing-based Counseling](https://aclanthology.org/2025.acl-long.1021/)**
  ...
  > **来源:** ACL 2025 Main · 2025 · `acl:2025.acl-long.1021`
...
- **[CATCH: A Novel Data Synthesis Framework for High Therapy Fidelity and Memory-Driven Planning Chain of Thought in AI Counseling](https://aclanthology.org/2025.findings-emnlp.543/)**
  ...
  > **来源:** EMNLP 2025 Findings · 2025 · `acl:2025.findings-emnlp.543`
...
- **[AuraDial: A Large-Scale Human-Centric Dialogue Dataset for Chinese AI Psychological Counseling](https://aclanthology.org/2025.findings-emnlp.155/)**
  ...
  > **来源:** EMNLP 2025 Findings · 2025 · `acl:2025.findings-emnlp.155`
...
- **[Structured Dialogue System for Mental Health: An LLM Chatbot Leveraging the PM+ Guidelines](https://arxiv.org/abs/2411.10681)**
  ...
  > **来源:** ICSR 2024 / arXiv · 2024-11 · `arxiv:2411.10681`
...
- **[MDD-5k: A New Diagnostic Conversation Dataset for Mental Disorders Synthesized via Neuro-Symbolic LLM Agents](https://arxiv.org/abs/2408.12142)**
  ...
  > **来源:** AAAI2025 / arXiv · 2024-11 · `arxiv:2408.12142`
...
- **[Interactive Agents: Simulating Counselor-Client Psychological Counseling via Role-Playing LLM-to-LLM Interactions](https://arxiv.org/abs/2408.15787)**
  ...
  > **来源:** arXiv · 2024-08-24 · `arxiv:2408.15787`
...
- **[Enhancing Psychotherapy Counseling: A Data Augmentation Pipeline Leveraging Large Language Models for Counseling Conversations](https://arxiv.org/abs/2406.08718)**
  ...
  > **来源:** IJCAI 2024 / arXiv · 2024-06 · `arxiv:2406.08718`
...
- **[Towards Conversational Diagnostic AI](https://arxiv.org/abs/2401.05654)**
  ...
  > **来源:** arxiv · 2024-01-11 · `arxiv:2401.05654`
...
- **[Unlocking LLMs: Addressing Scarce Data and Bias Challenges in Mental Health](https://aclanthology.org/2024.nlpaics-1.26/)**
  ...
  > **来源:** NLPAICS 2024 · 2024 · `acl:2024.nlpaics-1.26`
...
- **[Understanding the Therapeutic Relationship between Counselors and  Clients in Online Text-based Counseling using LLMs](https://aclanthology.org/2024.findings-emnlp.1025/)**
  ...
  > **来源:** EMNLP 2024 Findings · 2024 · `acl:2024.findings-emnlp.1025`
...
- **[SMILE: Single-turn to Multi-turn Inclusive Language Expansion via ChatGPT for Mental Health Support](https://aclanthology.org/2024.findings-emnlp.34/)**
  ...
  > **来源:** EMNLP 2024 Findings · 2024 · `acl:2024.findings-emnlp.34`
...
- **[Self-chats from Large Language Models Make Small Emotional Support Chatbot Better](https://aclanthology.org/2024.acl-long.611/)**
  ...
  > **来源:** ACL 2024 Main · 2024 · `acl:2024.acl-long.611`
...
- **[PsyChat: A Client-Centric Dialogue System for Mental Health Support](https://arxiv.org/abs/2312.04262)**
  ...
  > **来源:** CSCWD 2024 · 2024 · `arxiv:2312.04262`
...
- **[PATIENT-$\\Psi$: Using Large Language Models to Simulate Patients for Training Mental Health Professionals](https://aclanthology.org/2024.emnlp-main.711/)**
  ...
  > **来源:** EMNLP 2024 Main · 2024 · `acl:2024.emnlp-main.711`
...
- **[NoteChat: A Dataset of Synthetic Patient-Physician Conversations Conditioned on Clinical Notes](https://aclanthology.org/2024.findings-acl.901/)**
  ...
  > **来源:** ACL 2024 Findings · 2024 · `acl:2024.findings-acl.901`
...
- **[HealMe: Harnessing Cognitive Reframing in Large Language Models for Psychotherapy](https://aclanthology.org/2024.acl-long.93/)**
  ...
  > **来源:** ACL 2024 Main · 2024 · `acl:2024.acl-long.93`
...
- **[ESCoT: Towards Interpretable Emotional Support Dialogue Systems](https://aclanthology.org/2024.acl-long.723/)**
  ...
  > **来源:** ACL 2024 Main · 2024 · `acl:2024.acl-long.723`
...
- **[ESC-Eval: Evaluating Emotion Support Conversations in Large Language Models](https://aclanthology.org/2024.emnlp-main.883/)**
  ...
  > **来源:** EMNLP 2024 Main · 2024 · `acl:2024.emnlp-main.883`
...
- **[EmoLLM](https://github.com/SmartFlowAI/EmoLLM)**
  ...
  > **来源:** GitHub project · 2024 · `github:smartflowai/emollm`
...
- **[CPsyCoun: A Report-based Multi-turn Dialogue Reconstruction and Evaluation Framework for Chinese Psychological Counseling](https://aclanthology.org/2024.findings-acl.830/)**
  ...
  > **来源:** ACL 2024 Findings · 2024 · `acl:2024.findings-acl.830`
...
- **[CACTUS: Towards Psychological Counseling Conversations using Cognitive Behavioral Theory](https://aclanthology.org/2024.findings-emnlp.832/)**
  ...
  > **来源:** EMNLP 2024 Findings · 2024 · `acl:2024.findings-emnlp.832`
...
- **[Understanding Client Reactions in Online Mental Health Counseling](https://aclanthology.org/2023.acl-long.577/)**
  ...
  > **来源:** ACL 2023 Main · 2023 · `acl:2023.acl-long.577`
...
- **[Training Models to Generate, Recognize, and Reframe Unhelpful Thoughts](https://aclanthology.org/2023.acl-long.763/)**
  ...
  > **来源:** ACL 2023 Main · 2023 · `acl:2023.acl-long.763`
...
- **[SoulChat: Improving LLMs' Empathy, Listening, and Comfort Abilities through Fine-tuning with Multi-turn Empathy Conversations](https://aclanthology.org/2023.findings-emnlp.83/)**
  ...
  > **来源:** EMNLP 2023 Findings · 2023 · `acl:2023.findings-emnlp.83`
...
- **[MindChat](https://github.com/X-D-Lab/MindChat)**
  ...
  > **来源:** East China University of Science and Technology · 2023 · `github:x-d-lab/mindchat`
...
- **[Anno-MI: A Dataset of Expert-Annotated Counselling Dialogues](https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=9746035)**
  ...
  > **来源:** ICASSP 2022 · 2022 · `url:7d84a35dd236ba17`
...
- **[Automatic Identification of Ruptures in Transcribed Psychotherapy Sessions](https://aclanthology.org/2021.clpsych-1.15/)**
  ...
  > **来源:** the 7th Workshop on Computational Linguistics and Clinical Psychology · 2021 · `acl:2021.clpsych-1.15`
...
欢迎贡献。论文记录与生成视图必须保持同步。

1. 在 `.research-repo/papers.json` 中新增或更新记录，提供有来源支持的元数据和两种配置语言的摘要。
2. 运行 `python .research-repo/research_repo.py validate .`。
3. 运行 `python .research-repo/research_repo.py render .` 并检查生成的 README 变更。
4. 提交 Pull Request 前运行 `python .research-repo/research_repo.py validate . --check-rendered`。
